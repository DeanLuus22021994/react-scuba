...
export const CATEGORIES = ['All', 'Underwater', 'Marine Life', 'Divers', 'Boats', 'Reefs'] as const;
...
export const getImagesByCategory = (category: GalleryCategory): readonly GalleryImage[] => {
