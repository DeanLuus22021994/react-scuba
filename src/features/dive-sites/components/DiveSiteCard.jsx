  ...
  return (
    ...
    >
      <div className="relative h-48 overflow-hidden">
        <img src={site.image} alt={site.name} className="w-full h-full object-cover transition-transform duration-300 hover:scale-110" />
        <div className={`absolute top-4 right-4 ${DIFFICULTY_COLORS[site.difficulty]} px-4 py-2 rounded-full font-bold text-sm`}>
          {site.difficulty}
        </div>
      </div>
