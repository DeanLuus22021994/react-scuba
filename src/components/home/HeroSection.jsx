    ...
    return (
        <section className="relative h-screen flex items-center justify-center overflow-hidden">
            ...
            <div className="relative z-10 text-center text-white px-4 max-w-5xl mx-auto">
                ...
                >
                    PADI 5 Star ECO Green Fins Dive Centre in Pereybere. Explore 65 dive sites, wreck diving, turtle diving, shark diving, and exquisite coral reefs in warm crystal-clear waters.
                </motion.p>
