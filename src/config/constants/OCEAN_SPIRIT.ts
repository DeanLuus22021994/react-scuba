/**
 * Ocean Spirit Scuba Diving Mauritius - Content Data
 * Company information, contact details, and service offerings
 */
...
export interface OceanSpiritContent {
  name: string;
  tagline: string;
  contact: ContactInfo;
  about: AboutInfo;
...
export const OCEAN_SPIRIT_CONTENT: OceanSpiritContent = {
...
export default OCEAN_SPIRIT_CONTENT;
