 ...
 */
export function resolveFromSubdomain(hostname: string, baseDomain: string): string | null {
 ...
 */
export function resolveFromDomain(hostname: string, domainMap: Record<string, string>): string | null {
 ...
 */
export function resolveFromPath(pathname: string, pathPrefix = '/clients/'): string | null {
...
export class TenantResolver {
  ...
  resolve(context: TenantContext = {}): string | null {
    ...
    switch (this.strategy) {
      case 'subdomain':
        tenantSlug = context.hostname && this.baseDomain 
   ...
   */
  resolveWithFallbacks(context: TenantContext, strategies: TenantResolutionStrategy[] = []): string | null {
 ...
 */
export function resolveTenantInBrowser(options: TenantResolverOptions = {}): string | null {
