...
class Logger {
  ...
  error(message, error = {}) {
    ...
    console.error(JSON.stringify(this.formatLog(LOG_LEVELS.ERROR, message, meta)));
  }
   ...
   */
  warn(message, meta = {}) {
    console.warn(JSON.stringify(this.formatLog(LOG_LEVELS.WARN, message, meta)));
  }
  ...
  debug(message, meta = {}) {
    if (this.isDevelopment) {
      console.log(JSON.stringify(this.formatLog(LOG_LEVELS.DEBUG, message, meta)));
    }
  }
