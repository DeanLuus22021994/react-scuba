...
describe("Booking Routes Integration", () => {
	...
	describe("GET /api/bookings/:id", () => {
		...
		it("should handle service errors", async () => {
			BookingService.getBookingById = vi
				.fn()
	...
	describe("POST /api/bookings", () => {
		...
		it("should validate participant count range", async () => {
			...
			const participantError = response.body.errors.find(
				(err) => err.path === "participants",
			);
	...
	describe("PATCH /api/bookings/:id/status", () => {
		it("should update booking status", async () => {
			...
			BookingService.updateBookingStatus = vi
				.fn()
	...
	describe("DELETE /api/bookings/:id", () => {
		...
		it("should handle service errors", async () => {
			BookingService.deleteBooking = vi
				.fn()
				.mockRejectedValue(new Error("Database error"));
