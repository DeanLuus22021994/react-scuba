...
describe("ValidationService", () => {
	...
	describe("validateBookingBusinessRules", () => {
		...
		it("should reject past dates", () => {
			const pastDate = {
				...validBooking,
				preferredDate: "2025-10-28T10:00:00Z",
			};
		...
		it("should reject dates too far in future", () => {
			const farFuture = {
				...validBooking,
				preferredDate: "2027-01-01T10:00:00Z",
			};
	...
	describe("sanitizeBookingInput", () => {
		it("should sanitize string inputs", () => {
			...
			expect(result.specialRequests).toBe(
				"Please provide vegetarian meals & equipment",
			);
		});
		...
		it("should preserve safe HTML in special requests", () => {
			const input = {
				name: "John Doe",
				specialRequests:
					"Need <strong>waterproof</strong> case and <em>extra</em> weights",
			};

			const result = sanitizeBookingInput(input);

			expect(result.specialRequests).toBe(
				"Need waterproof case and extra weights",
			);
		});
